...
<head runat="server">
    ...
    <style>
        ...
        /* Modal Body */
        .modal-body {
            padding: 20px 24px; /* Body padding */
            font-size: 14px; /* Font size for body */
            color: #555; /* Text color */
        }

        .modal-footer {
            padding: 16px 24px; /* Footer padding */
            text-align: right; /* Align buttons to the right */
            border-top: 1px solid #ddd; /* Border for footer */
        }
        ...
        .btn-secondary {
            background-color: #f0f0f0; /* Secondary button background */
            border-color: #ccc;
            color: #333;
        }

            .btn-secondary:hover {
                background-color: #e2e2e2; /* Lighter on hover */
            }
        ...
        /* Modal Custom Scroll */
        .modal-body {
            max-height: calc(80vh - 160px); /* Set a max-height for the body */
        ...
        #selectTemplateModal .btn-primary {
            background-color: #6200ea;
            border-color: #6200ea;
        }

        #selectTemplateModal .btn-secondary {
        ...
        .modal-header .btn-close {
            color: #5a5a5a; /* Close button icon color */
            font-size: 1.5rem;
        }

        /* Remove default padding from modal */
        .modal-body {
            padding: 20px 24px;
        }

            /* Apply Material Design spacing */
            .mb-3, .modal-body .form-group {
                margin-bottom: 16px;
            }
